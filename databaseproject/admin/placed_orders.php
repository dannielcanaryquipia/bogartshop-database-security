...
// If the default admin is logged in, block access to the Placed Orders page
if ($is_default_admin) {
    $block_message = "Access Denied. Default Admin cannot access the Placed Orders page.";
}

if (isset($_POST['update_payment']) && !$is_default_admin) {
