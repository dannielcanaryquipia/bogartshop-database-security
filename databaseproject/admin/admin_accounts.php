...
// If the default admin is logged in, block access to the Admin Accounts page
if ($is_default_admin) {
    $block_message = "Access Denied. Default Admin cannot access the Admin Accounts page.";
}
